...
System.out.println(str3+"after replacing all occurence of e top a :"+
str3.replace('e','a'));
char ch[]=str3.toCharArray();
for(int i=0;i<ch.length;i++)
System.out.println("character at "+(i+1)+" is "+ch[i]);
System.out.println("Index position of the substring "+str2+" is "
+str3.indexOf(str2));
System.out.println("DEMONSTRATING STRING MANIPULATION
...
System.out.println("enter a position where the substring has to be
inserted: ");
int pos =sc.nextInt();
